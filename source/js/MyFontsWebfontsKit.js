...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/27031a';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"HapnaSlabSerif-Light","url":wfpath+"27031A_0"+suffix+"_0."+webfontType},{"fontFamily":"HapnaSlabSerif-ExtraBold","url":wfpath+"27031A_1"+suffix+"_0."+webfontType},{"fontFamily":"Hapna","fontWeight":"normal","fontStyle":"normal","url":wfpath+"27031A_2"+suffix+"_0."+webfontType},{"fontFamily":"Hapna","fontWeight":"bold","fontStyle":"normal","url":wfpath+"27031A_3"+suffix+"_0."+webfontType}];var len=fonts.length;document.write("<style>");for(var i=0;i<len;i++){if(webfontType=="svg#wf"){var format="svg";}
